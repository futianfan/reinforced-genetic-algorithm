...
for num_gen in tqdm(range(args_dict['num_generations'])):
    for receptor_info in receptor_info_list:
        ...
        print("---------- 4. elite from previous generation TODO ----------")
        ...
        ############# policy gradient ##############
        print('------ 7. crossover policy network optimization -------')
        ...
        print('------ 8. mutation policy network optimization -------')
